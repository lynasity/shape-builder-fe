...
async function createPercentFillV3(background: string, fillColor: string, transparency: number, removeBackground: boolean): Promise<coreImg> {
...
export default createPercentFillV3;
